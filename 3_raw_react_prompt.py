...
def get_tool_descriptions(tools_dict):
    ...
    for tool_name , tool_function in tools_dict.items():
        original_function = getattr(tool_function, "__wrapped__", None)
...
def ollama_chat_traced(model, messages, options):
    return ollama.chat(model=model, tools=messages, options=options)
...
if __name__ == "__main__":
    ...
    print()
    result = run_agents("What is the price of a laptop after applying a gold discount")
